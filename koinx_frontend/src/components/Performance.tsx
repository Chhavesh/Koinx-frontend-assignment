        ...
        <div className="py-4 mt-2">
          <div className="flex justify-between ">
            ...
            <div className="w-[500px] h-2 mx-4">
              ...
              <div className="relative top-1/2 left-3/4 transform -translate-x-10 -translate-y-4 mt-4">
                <svg
                  viewBox="0 0 100 100" className="lg:w-3 w-2 fill-current text-black ml-7">
